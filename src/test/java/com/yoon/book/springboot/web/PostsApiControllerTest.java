...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // WebMvcTest는 jpa 기능이 작동하지 않는다.
//jpa 기능과 외부라이브러리를 한번에 테스트 하기 위해서는 SpringBootTest와 TestRestTemplate를 같이 써야한다.
public class PostsApiControllerTest{
  ...
  @Test
    @WithMockUser(roles="USER")//인증된 모의 가짜사용자
